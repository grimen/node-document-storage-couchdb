# NODE-DOCUMENT-STORAGE-COUCHDB [![Build Status](https://secure.travis-ci.org/grimen/node-document-storage-couchdb.png)](http://travis-ci.org/grimen/node-document-storage-couchdb)
